...
const createAdmin = async () => {
  try {
    ...
    const password = args[2] || 'ArtisanPass123!';
    const avatarUrl = args[3] || 'https://plus.unsplash.com/premium_photo-1689977927774-401b12d137d6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
    ...
    if (user) {
      ...
      user.isActive = true;
      await user.save();
      console.log(`[Admin Creator] Existing user ${email} upgraded to ADMIN successfully!`);
    } else {
